...
module.exports = {
    entry  : {
        ...
        'mega-menu' : asset('js/partials/mega-menu.js'),
        'category-menu' : asset('js/partials/category-menu.js'),
        ...
        'reels': asset('js/partials/reels.js'),
        'product-360': asset('js/partials/product-360.js'),
